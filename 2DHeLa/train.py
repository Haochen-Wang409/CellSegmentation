...
def main(args):
    ...
    # model
    model = unet.UNet(args.num_kernel, args.kernel_size, train_dataset.dim, train_dataset.target_dim)
    ...
    for epoch in range(args.epoch):
        ...
        for i, (x_train, y_train) in tqdm(enumerate(train_dataloader)):
            ...
            if i == 0:
                ...
                # TODO display segmentations based on number of output
